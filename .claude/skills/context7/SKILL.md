...
description: |
  Up-to-date library documentation retrieval using Context7 MCP tools.
  Process: THINK → RESOLVE → FETCH → APPLY.
  Use when: fetching library docs, resolving package names to IDs, 
  getting implementation guides, exploring API references.
  Tools: /mcp__context7__resolve-library-id, /mcp__context7__get-library-docs.
  Provides: package resolution strategy, trust score evaluation, 
  token scaling (3K-20K), topic selection patterns.
---
