...
- Prerequisites: plan.md (required), spec.md (required for user stories), ux.md (required for flows, patterns), research.md, data-model.md, contracts/
...
**Template:**
- Plan: @.claude/templates/tasks-template.md
...
1. **Load design documents**: Read from FEATURE_DIR:
   - **Required**: plan.md (tech stack, libraries, structure, test scenarios), spec.md (user stories with priorities), ux.md (flows, patterns)
   - **Optional**: data-model.md (entities), contracts/ (API endpoints), research.md (decisions), setup.md (quick start)
   - Note: Not all projects have all documents. Generate tasks based on what's available.

2. **Execute task generation workflow**:
   - Load plan.md and extract tech stack, libraries, project structure
   - Load spec.md and extract user stories with their priorities (P1, P2, P3, etc.)
   - Load ux.md and extract flows, patterns
...
3. **Generate tasks.md**: Use `.claude/templates/tasks-template.md` as structure, fill with:
